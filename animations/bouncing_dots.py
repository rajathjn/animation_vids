...
from .physics import DotState, PhysicsSimulation, create_dot_states_from_config
...
class BouncingDots(Scene):
    ...
    def construct(self) -> None:
        ...
        mixed_path = mixer.generate_mixed_audio(
            total_duration, output_filename="bounce_multi_with_audio.wav"
        )
    ...
    def _setup_scene(self) -> None:
        ...
        circle = Circle(
            radius=cfg.CIRCLE_RADIUS, color=cfg.CIRCLE_COLOR, stroke_width=cfg.CIRCLE_STROKE_WIDTH
        )
        self.add(circle)
